...
def model_bilstm(modelname_tosave):
    ...
    plt.tight_layout()
    plt.savefig('results/model_bilstm_bs32.png')
    plt.close()
    ...
    with open("results/bilstm_results.txt", "a") as myfile:
        myfile.write("(bilstm_model(bs32,hl128,em100) \n accuracy={0}\n validation_accuracy={1}\n loss={2}\n validation_loss={3}\n test_score={4}, train_time={5}\n".format(
...
model_bilstm("modelbilstm_bs32")
model_bilstm_pre("modelbilstm_pre_bs32")